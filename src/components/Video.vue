...
a.video {
  ...
  div.details {
    ...
    h1.title {
      padding: 8px 0;
      color: var(--title); font-size: 13px; font-weight: 600;
      overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
    }

    span.views { font-size: 13px; font-weight: 500; }
  }
  ...
  footer.bottom {
    ...
    a.creator-details {
      ...
      h1.name { color: var(--title); font-size: 13px; font-weight: 500; }
    }

    span.dot { font-size: 10px; margin: 0 4px; }
  }
}
